...
The script will scan the entire filesystem, including archives (WARs, EARs, ZIPs and nested JARs ) for the Java class that indicates the Java application contains a vulnerable Log4j library. 
